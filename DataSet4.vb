...
Public Class DataSet4
    ...
    Public Class НастройкиDataTable
        ...
        Private columnИспользоватьПароль As DataColumn
        
        Private columnПарольПользователя As DataColumn
        
        Private columnПоверхОкон As DataColumn
        ...
        Friend ReadOnly Property ИспользоватьПарольColumn As DataColumn
            Get
                Return Me.columnИспользоватьПароль
            End Get
        End Property
        
        Friend ReadOnly Property ПарольПользователяColumn As DataColumn
            Get
                Return Me.columnПарольПользователя
            End Get
        End Property
        
        Friend ReadOnly Property ПоверхОконColumn As DataColumn
            Get
                Return Me.columnПоверхОкон
            End Get
        End Property
        ...
        Public Overloads Function AddНастройкиRow(ByVal ИмяПользователя As String, ByVal ИмяШрифта As String, ByVal ИспользоватьПароль As Integer, ByVal ПарольПользователя As String, ByVal ПоверхОкон As Integer, ByVal РазмерШрифта As String, ByVal ФорматированиеМодуля As Integer) As НастройкиRow
            Dim rowНастройкиRow As НастройкиRow = CType(Me.NewRow,НастройкиRow)
            rowНастройкиRow.ItemArray = New Object() {ИмяПользователя, ИмяШрифта, ИспользоватьПароль, ПарольПользователя, ПоверхОкон, РазмерШрифта, Nothing, ФорматированиеМодуля}
        ...
        Friend Sub InitVars()
            ...
            Me.columnИспользоватьПароль = Me.Columns("ИспользоватьПароль")
            Me.columnПарольПользователя = Me.Columns("ПарольПользователя")
            Me.columnПоверхОкон = Me.Columns("ПоверхОкон")
        ...
        Private Sub InitClass()
            ...
            Me.columnИспользоватьПароль = New DataColumn("ИспользоватьПароль", GetType(System.Int32), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnИспользоватьПароль)
            Me.columnПарольПользователя = New DataColumn("ПарольПользователя", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnПарольПользователя)
            Me.columnПоверхОкон = New DataColumn("ПоверхОкон", GetType(System.Int32), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnПоверхОкон)
    ...
    Public Class НастройкиRow
        ...
        Public Property ИмяПользователя As String
            Get
                Try 
                    Return CType(Me(Me.tableНастройки.ИмяПользователяColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Невозможно получить значение, т.к. оно является DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableНастройки.ИмяПользователяColumn) = value
            End Set
        End Property
        ...
        Public Property ИспользоватьПароль As Integer
            Get
                Try 
                    Return CType(Me(Me.tableНастройки.ИспользоватьПарольColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Невозможно получить значение, т.к. оно является DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableНастройки.ИспользоватьПарольColumn) = value
            End Set
        End Property
        
        Public Property ПарольПользователя As String
            Get
                Try 
                    Return CType(Me(Me.tableНастройки.ПарольПользователяColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Невозможно получить значение, т.к. оно является DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableНастройки.ПарольПользователяColumn) = value
            End Set
        End Property
        
        Public Property ПоверхОкон As Integer
            Get
                Try 
                    Return CType(Me(Me.tableНастройки.ПоверхОконColumn),Integer)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Невозможно получить значение, т.к. оно является DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableНастройки.ПоверхОконColumn) = value
            End Set
        End Property
        ...
        Public Function IsИмяПользователяNull() As Boolean
            Return Me.IsNull(Me.tableНастройки.ИмяПользователяColumn)
        End Function
        
        Public Sub SetИмяПользователяNull()
            Me(Me.tableНастройки.ИмяПользователяColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsИспользоватьПарольNull() As Boolean
            Return Me.IsNull(Me.tableНастройки.ИспользоватьПарольColumn)
        End Function
        
        Public Sub SetИспользоватьПарольNull()
            Me(Me.tableНастройки.ИспользоватьПарольColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsПарольПользователяNull() As Boolean
            Return Me.IsNull(Me.tableНастройки.ПарольПользователяColumn)
        End Function
        
        Public Sub SetПарольПользователяNull()
            Me(Me.tableНастройки.ПарольПользователяColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsПоверхОконNull() As Boolean
            Return Me.IsNull(Me.tableНастройки.ПоверхОконColumn)
        End Function
        
        Public Sub SetПоверхОконNull()
            Me(Me.tableНастройки.ПоверхОконColumn) = System.Convert.DBNull
        End Sub
